...
const plans = [
  {
    ...
    subtitle: 'Senior full-stack developers & tech lead embedded into your product roadmap.',
    price: '$3500',
    period: '/m.',
    features: [
      'Dedicated Senior Full-Stack Engineer(s)',
      'Direct Slack / Discord & Git integration',
      'Daily Agile standups & weekly sprint demos',
      'Full source code & 100% IP ownership',
      'CI/CD, automated testing & cloud deployments',
  ...
  },
  {
    ...
    isDark: false,
    badge: 'FIXED SCOPE',
    title: 'Standard Product Sprint',
    subtitle: 'Defined timeline and guaranteed deliverables for MVP builds or major feature modules.',
    price: '$2000',
    period: '/m.',
    features: [
      'Comprehensive architecture spec & UX',
      'Complete milestone-based delivery',
      'Zero scope creep or unexpected billings',
      'Multi-currency payment & cloud database setup',
      'Production hardening & monitoring',
      '30-Day post-launch warranty & maintenance',
    ],
    ctaText: 'Start Standard Sprint',
    ctaLink: '/contact',
  },
];
