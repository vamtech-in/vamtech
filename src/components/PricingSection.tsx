...
const plans = [
  {
    ...
    subtitle: 'From idea to live working product. Perfect for founders testing market demand.',
    price: '$599',
    period: '/sprint',
    features: [
      'Full-stack Next.js / React Web or Mobile App',
      'User auth, database, & payment integration',
      'Live deployment on Vercel / Cloud Edge',
      'Daily progress updates & GitHub repo access',
      '100% source code & full IP ownership',
      '14-day post-launch warranty & bug fixes',
    ],
  ...
  },
  {
    ...
    subtitle: 'Continuous engineering velocity to build, scale, and iterate on your product roadmap.',
    price: '$1199',
    period: '/m.',
    features: [
      'Dedicated Full-Stack Developer(s)',
      'Direct communication on Slack or Discord',
      'Weekly live sprint demos & milestone releases',
      'CI/CD, API automations, & database scaling',
      'Flexible month-to-month scaling (no long contracts)',
      'Fractional tech lead guidance & code reviews',
    ],
    ctaText: 'Hire Dedicated Pod',
    ctaLink: '/contact',
  },
];
